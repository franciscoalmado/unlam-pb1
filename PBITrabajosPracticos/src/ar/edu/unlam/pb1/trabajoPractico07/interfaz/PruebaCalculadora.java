package ar.edu.unlam.pb1.trabajoPractico07.interfaz;
...
public class PruebaCalculadora {
	...
	public static void main(String[] args) {
		...
		System.out.println("Factorial - La Calculadora del Celular: "+laCalculadoraDelCelular.factorial((int)operador1));
		System.out.println("Factorial - Calculadora Casio: "+casio.factorial((int)operador2));
	}
}